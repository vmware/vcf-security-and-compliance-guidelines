...
This directory contains code samples for encryption features in VMware vSphere and VMware Cloud Foundation.
...
Demonstrates how to audit encryption status across a VMware vCenter instance, including examples of how to:
...
- Detect encrypted First Class Disks (FCDs) across datastores, relevant for Kubernetes environments, including VMware vSphere Kubernetes Service (VKS)

## change-keyprovider.ps1

Demonstrates how to migrate a vCenter instance from one key provider to another, performing a shallow rekey of all encrypted objects. Includes examples of how to:
...
- **Host rekey**: Rekey ESX hosts participating in encryption
