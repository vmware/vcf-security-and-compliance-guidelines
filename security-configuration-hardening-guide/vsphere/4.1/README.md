# vSphere 4.1 Security Configuration & Hardening Guide
...
Download this version of the guide from the file list in this directory. You may need to click the "Download Raw File" button.
...
Feedback on archived materials will not result in updates.
