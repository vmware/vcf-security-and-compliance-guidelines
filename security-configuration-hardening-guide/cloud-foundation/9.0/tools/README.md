...
**Important**: Under no circumstances do we recommend storing account logon information in a script. Stored credentials are a common path to unauthorized access and can lead to ransomware.
