...
- [ ] Check for suspicious environment variables in running processes (vCenter and other Linux-based appliances; the ESX shell cannot read process environments)
...
**For VMware Appliances (vCenter, NSX, VCF Operations, and SDDC Manager on VCF 5.x and earlier):**
