# Secure Controls Framework (SCF) 2026.1

The **Secure Controls Framework (SCF)** is an open-source meta-framework that provides a comprehensive catalog of security and privacy controls. SCF maps its controls to over one hundred statutory, regulatory, and contractual frameworks, allowing organizations to address multiple compliance obligations through a single control set. Version 2026.1 is the current release.
...
- [SCF 2026.1 Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1.xlsx) -- direct download
- [SCF 2026.1 Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1.csv) -- direct download
- [SCF 2026.1 Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1.md) -- direct download
- [SCF 2026.1 Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/scf-2026-1/vcf-91-companion-scf-2026-1-scg-by-control.md) -- direct download
