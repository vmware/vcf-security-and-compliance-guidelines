...
The **Cyber Resilience Act (CRA)**, formally Regulation (EU) 2024/2847, establishes horizontal cybersecurity requirements for products with digital elements placed on the EU market. It sets essential cybersecurity requirements for product properties and vulnerability handling (Annex I), obligations for manufacturers, importers, and distributors, reporting obligations for actively exploited vulnerabilities and severe incidents, and conformity assessment procedures, with important and critical product categories subject to stricter assessment routes. The SCF 2026.1 crosswalk was mapped against the 2022 Commission proposal; the control identifiers in this guide use the adopted regulation's numbering, with each proposal-to-final mapping verified against both texts.
...
- [EU CRA Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra.xlsx) -- direct download
- [EU CRA Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra.csv) -- direct download
- [EU CRA Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra.md) -- direct download
- [EU CRA Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-cra/vcf-91-companion-eu-cra-scg-by-control.md) -- direct download

## External Resources

- [Regulation (EU) 2024/2847 (eur-lex.europa.eu)](https://eur-lex.europa.eu/eli/reg/2024/2847/oj)
