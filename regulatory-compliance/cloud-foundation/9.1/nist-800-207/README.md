...
**NIST Special Publication 800-207, Zero Trust Architecture**, describes zero trust as a set of cybersecurity paradigms that move defenses from static, network-based perimeters to a focus on users, assets, and resources. Rather than prescribing individual controls, it states seven basic tenets that a zero trust architecture is designed and deployed to adhere to: all data sources and computing services are resources; all communication is secured regardless of network location; access is granted per session; access is determined by dynamic policy; the enterprise monitors the integrity and security posture of its assets; authentication and authorization are dynamic and strictly enforced; and the enterprise collects and uses information about its current state to improve its security posture.
...
- [NIST SP 800-207 Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207.xlsx) -- direct download
- [NIST SP 800-207 Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207.csv) -- direct download
- [NIST SP 800-207 Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207.md) -- direct download
- [NIST SP 800-207 Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-207/vcf-91-companion-nist-800-207-scg-by-control.md) -- direct download

## External Resources

- [NIST SP 800-207, Zero Trust Architecture (csrc.nist.gov)](https://csrc.nist.gov/pubs/sp/800/207/final)
- [NIST SP 800-207 PDF (nvlpubs.nist.gov)](https://nvlpubs.nist.gov/nistpubs/specialpublications/NIST.SP.800-207.pdf)
