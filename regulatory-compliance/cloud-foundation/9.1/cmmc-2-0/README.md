...
The **Cybersecurity Maturity Model Certification (CMMC) 2.0** program, administered by the US Department of Defense, requires defense contractors and subcontractors that handle Federal Contract Information (FCI) or Controlled Unclassified Information (CUI) to implement cybersecurity practices at one of three levels. Level 1 covers the basic safeguarding requirements of FAR 52.204-21, Level 2 covers the security requirements of NIST SP 800-171 Revision 2, and Level 3 adds selected enhanced requirements from NIST SP 800-172. This guide covers the practices at all three levels.
...
- [CMMC 2.0 Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0.xlsx) -- direct download
- [CMMC 2.0 Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0.csv) -- direct download
- [CMMC 2.0 Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0.md) -- direct download
- [CMMC 2.0 Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cmmc-2-0/vcf-91-companion-cmmc-2-0-scg-by-control.md) -- direct download

## External Resources

- [CMMC (dodcio.defense.gov)](https://dodcio.defense.gov/CMMC/)
- [NIST SP 800-171 Revision 2 (nvlpubs.nist.gov)](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-171r2.pdf)
