# FedRAMP Revision 5 (Moderate Baseline)

The **Federal Risk and Authorization Management Program (FedRAMP)** is a US government program that standardizes the security assessment, authorization, and continuous monitoring of cloud products and services used by federal agencies. Its Revision 5 baselines select and tailor controls from NIST SP 800-53 Revision 5 at the Low, Moderate, and High impact levels, with an additional LI-SaaS baseline for low-impact software as a service. This guide carries the **Moderate baseline**, the level used for most agency authorizations; control identifiers and descriptions are those of the underlying NIST SP 800-53 Revision 5 controls.
...
- [FedRAMP Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5.xlsx) -- direct download
- [FedRAMP Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5.csv) -- direct download
- [FedRAMP Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5.md) -- direct download
- [FedRAMP Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/fedramp-r5/vcf-91-companion-fedramp-r5-scg-by-control.md) -- direct download

## External Resources

- [FedRAMP Rev 5 Baselines (fedramp.gov)](https://www.fedramp.gov/rev5/baselines/)
