...
**Cyber Essentials** is a UK government-backed certification scheme operated by the National Cyber Security Centre (NCSC). It helps organizations protect themselves against common internet-based attacks through five technical control themes: firewalls, secure configuration, security update management, user access control, and malware protection.
...
- [Cyber Essentials Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials.xlsx) -- direct download
- [Cyber Essentials Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials.csv) -- direct download
- [Cyber Essentials Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials.md) -- direct download
- [Cyber Essentials Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/cyber-essentials/vcf-91-companion-cyber-essentials-scg-by-control.md) -- direct download

## External Resources

- [Cyber Essentials (ncsc.gov.uk)](https://www.ncsc.gov.uk/cyberessentials/overview)
