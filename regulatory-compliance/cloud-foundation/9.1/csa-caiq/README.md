# CSA Consensus Assessments Initiative Questionnaire (CAIQ) 4.1.0

The **Consensus Assessments Initiative Questionnaire (CAIQ)**, published by the Cloud Security Alliance (CSA), is the assessment companion to the Cloud Controls Matrix (CCM). It restates each CCM control as one or more yes/no questions that a cloud service provider answers to document how it meets the control, and it is the basis of CSA STAR self-assessments. Each question in this guide is mapped to the Secure Controls Framework through its parent CCM control, which is shown in the CCM Control column.
...
- [CSA CAIQ Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq.xlsx) -- direct download
- [CSA CAIQ Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq.csv) -- direct download
- [CSA CAIQ Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq.md) -- direct download
- [CSA CAIQ Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-caiq/vcf-91-companion-csa-caiq-scg-by-control.md) -- direct download

## External Resources

- [Cloud Controls Matrix and CAIQ (cloudsecurityalliance.org)](https://cloudsecurityalliance.org/research/cloud-controls-matrix)
