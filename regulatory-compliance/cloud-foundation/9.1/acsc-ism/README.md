...
The **Australian Signals Directorate Information Security Manual (ISM)** is a framework of cybersecurity principles and guidelines that organisations can apply, using their risk management framework, to protect their systems and data from cyberthreats. The ISM is organised into cybersecurity guidelines containing individually numbered controls covering governance, physical security, personnel security, and information and communications technology security. This guide maps to the June 2024 release of the ISM via the Secure Controls Framework.
...
- [Australian ISM Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism.xlsx) -- direct download
- [Australian ISM Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism.csv) -- direct download
- [Australian ISM Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism.md) -- direct download
- [Australian ISM Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/acsc-ism/vcf-91-companion-acsc-ism-scg-by-control.md) -- direct download

## External Resources

- [Australian Signals Directorate Information Security Manual (cyber.gov.au)](https://www.cyber.gov.au/resources-business-and-government/essential-cybersecurity/ism)
