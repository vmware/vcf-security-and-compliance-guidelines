...
**MITRE ATT&CK** is a knowledge base of adversary tactics, techniques, and sub-techniques based on real-world observations, maintained by The MITRE Corporation. This guide maps VMware Cloud Foundation and its advanced services to ATT&CK version 16 techniques via the Secure Controls Framework; each control row is a technique or sub-technique, and the responses describe product capabilities relevant to defending against it. ATT&CK is a registered trademark of The MITRE Corporation; technique names and descriptions are reproduced from the ATT&CK knowledge base under its terms of use.
...
- [MITRE ATT&CK Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack.xlsx) -- direct download
- [MITRE ATT&CK Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack.csv) -- direct download
- [MITRE ATT&CK Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack.md) -- direct download
- [MITRE ATT&CK Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/mitre-attack/vcf-91-companion-mitre-attack-scg-by-control.md) -- direct download

## External Resources

- [MITRE ATT&CK (attack.mitre.org)](https://attack.mitre.org/)
- [ATT&CK Terms of Use (attack.mitre.org)](https://attack.mitre.org/resources/legal-and-branding/terms-of-use/)
