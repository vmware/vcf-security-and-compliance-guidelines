# NIST SP 800-82 Revision 3 (High OT Overlay)

**NIST Special Publication 800-82 Revision 3, Guide to Operational Technology (OT) Security**, provides guidance on improving the security of operational technology, including industrial control systems, supervisory control and data acquisition systems, and other control system configurations, while addressing their unique performance, reliability, and safety requirements. It tailors the NIST SP 800-53 control catalog into OT overlays at the Low, Moderate, and High impact levels. This guide carries the **High-impact OT overlay**; control identifiers and descriptions are those of the underlying NIST SP 800-53 Revision 5 controls.
...
- [NIST SP 800-82 R3 Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3.xlsx) -- direct download
- [NIST SP 800-82 R3 Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3.csv) -- direct download
- [NIST SP 800-82 R3 Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3.md) -- direct download
- [NIST SP 800-82 R3 Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/nist-800-82-r3/vcf-91-companion-nist-800-82-r3-scg-by-control.md) -- direct download

## External Resources

- [NIST SP 800-82 Revision 3 (csrc.nist.gov)](https://csrc.nist.gov/pubs/sp/800/82/r3/final)
- [NIST SP 800-53 Revision 5 (nvlpubs.nist.gov)](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-53r5.pdf)
