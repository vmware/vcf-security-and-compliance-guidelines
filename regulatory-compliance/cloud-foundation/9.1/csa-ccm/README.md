...
The **Cloud Controls Matrix (CCM)**, published by the Cloud Security Alliance (CSA), is a cybersecurity control framework for cloud computing. Version 4.1.0 organizes its controls into domains covering audit and assurance, application and interface security, business continuity, change control, cryptography and key management, datacenter and data security, governance, human resources, identity and access management, the new identity and secrets domain, interoperability, logging and monitoring, security incident management, supply chain and transparency, threat and vulnerability management, and endpoint management. The controls are designed around the shared responsibility model between cloud service providers and their customers.
...
- [CSA Cloud Controls Matrix Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm.xlsx) -- direct download
- [CSA Cloud Controls Matrix Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm.csv) -- direct download
- [CSA Cloud Controls Matrix Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm.md) -- direct download
- [CSA Cloud Controls Matrix Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/csa-ccm/vcf-91-companion-csa-ccm-scg-by-control.md) -- direct download

## External Resources

- [Cloud Controls Matrix (cloudsecurityalliance.org)](https://cloudsecurityalliance.org/research/cloud-controls-matrix)
