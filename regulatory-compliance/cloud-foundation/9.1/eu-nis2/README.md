...
The **NIS2 Directive**, formally Directive (EU) 2022/2555, is the European Union's updated legislation on cybersecurity. It replaces the original NIS Directive (2016/1148) and broadens the scope of sectors and entities subject to cybersecurity risk management and incident reporting obligations. NIS2 introduces stronger supervisory measures, stricter enforcement requirements, and harmonized sanctions across EU member states.
...
- [NIS2 Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2.xlsx) -- direct download
- [NIS2 Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2.csv) -- direct download
- [NIS2 Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2.md) -- direct download
- [NIS2 Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/eu-nis2/vcf-91-companion-eu-nis2-scg-by-control.md) -- direct download
