...
The **SWIFT Customer Security Controls Framework (CSCF)**, part of the SWIFT Customer Security Programme (CSP), defines mandatory and advisory security controls for SWIFT users. The controls are organized around three objectives (secure your environment, know and limit access, and detect and respond) and are attested annually by each SWIFT user.
...
- [SWIFT CSCF Companion Guide for VMware Cloud Foundation 9.1 (XLSX)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf.xlsx) -- direct download
- [SWIFT CSCF Companion Guide for VMware Cloud Foundation 9.1 (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf.csv) -- direct download
- [SWIFT CSCF Companion Guide for VMware Cloud Foundation 9.1 (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf.md) -- direct download
- [SWIFT CSCF Companion Guide for VMware Cloud Foundation 9.1 (PDF)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf.pdf) -- direct download
...
- [SCG hardening controls relevant to this framework (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf-scg.csv) -- direct download
- [SCG hardening controls relevant to this framework (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf-scg.md) -- direct download
- [Framework controls by relevant SCG hardening control (CSV)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf-scg-by-control.csv) -- direct download
- [Framework controls by relevant SCG hardening control (Markdown)](https://raw.githubusercontent.com/vmware/vcf-security-and-compliance-guidelines/main/regulatory-compliance/cloud-foundation/9.1/swift-csf/vcf-91-companion-swift-csf-scg-by-control.md) -- direct download

## External Resources

- [SWIFT Customer Security Programme (swift.com)](https://www.swift.com/myswift/customer-security-programme-csp)
